...
Nishant Ranjan Singh & 2401010301 &
  ...
  \textbf{M2:} ChromaDB RAG foundation, Cloud deployment, LaTeX report, end-to-end system testing. \\
Atanu Adhikari & 2401010111 &
  \textbf{M1:} Synthetic dataset creation, TF-IDF, SMOTE, hyperparameter tuning.
  \textbf{M2:} LangGraph orchestration, ChromaDB RAG foundation, PDF ingestion pipeline. \\
Sambhav Kumar & 2401010409 &
  \textbf{M1:} Presentation development, QA on preprocessing, abstract writing.
